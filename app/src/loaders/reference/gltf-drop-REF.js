...
//zip libraries -- TODO: this could be moved out from window, most likely
const zip = window.zip = require('../lib/zip');
require('../lib/zip-fs'); //adds fs functionality to zip lib
 ...
 */
export default class DropController extends EventEmitter {
  ...
  loadZip (file) {
    ...
    //
    window.alert("zip files are not supported currently, please upzip and try again");
    //TODO: importBlob is not working correctly for some reason...
    //      there might be a better way to do this with Zlib (THREE supported zip lib)
